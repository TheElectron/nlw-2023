    ...
    return(
        <form onSubmit={createNewHabit}
            ...
            <input 
                ...
                placeholder="Ex.: Praticar natação, dormir 8 hrs, etc."
                autoFocus 
                value={title}
            ...
            <button type="submit" className="mt-6 rounded-lg p-4 flex items-center justify-center gap-3 font-semibold bg-green-600 hover:bg-green-400 transition-colors">
